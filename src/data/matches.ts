...
export const worldCupMatches: Match[] = [
  // Grupo A
  { id: 1, homeTeam: 'México', homeTeamFlag: teamFlags['México'], awayTeam: 'Sudáfica', awayTeamFlag: teamFlags['Sudáfica'], date: '2026-06-11', time: '13:00', venue: 'Estadio Azteca', venueImage: venueImages['Estadio Azteca'], city: 'Ciudad de México', country: 'MEX', group: 'A', stage: 'group' },
  ...
  { id: 25, homeTeam: 'República Checa', homeTeamFlag: teamFlags['República Checa'], awayTeam: 'Sudáfica', awayTeamFlag: teamFlags['Sudáfica'], date: '2026-06-18', time: '12:00', venue: 'Mercedes-Benz Stadium', venueImage: venueImages['Mercedes-Benz Stadium'], city: 'Atlanta', country: 'USA', group: 'A', stage: 'group' },
  ...
  { id: 54, homeTeam: 'Sudáfica', homeTeamFlag: teamFlags['Sudáfica'], awayTeam: 'Corea del Sur', awayTeamFlag: teamFlags['Corea del Sur'], date: '2026-06-24', time: '19:00', venue: 'Estadio Monterrey', venueImage: venueImages['Estadio Monterrey'], city: 'Monterrey', country: 'MEX', group: 'A', stage: 'group' },
